...
class TestAppLoadMP(TestCase):
    ...
    def test_ingestTestSets1(self):
        ...
        for test in test_sets:
            ...
            self.assertEquals(num_hosts, test[1], "test_ingestTestSets failed!")
            self.assertEquals(num_instances, test[2], "test_ingestTestSets failed!")
            self.assertEquals(num_entries, test[3], "test_ingestTestSets failed!")
